...
Read [the docs](https://natlabrockies.github.io/floorspace.js/docs) then try out the [latest development version](https://natlabrockies.github.io/floorspace.js/) in your browser.
